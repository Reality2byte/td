...
td_api::object_ptr<td_api::sponsoredMessage> SponsoredMessageManager::get_sponsored_message_object(
  ...
  return td_api::make_object<td_api::sponsoredMessage>(
      ...
      get_message_content_object(sponsored_message.content.get(), td_, dialog_id, MessageId(ServerMessageId(1)),
                                 dialog_id, false, false, false, dialog_id, 0, false, true, -1, false, true),
